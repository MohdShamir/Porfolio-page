...
const About = () => {
  const stats = [
    { number: "Wanderlust", label: 'Project Built', color: 'text-blue-500' },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          <div className="space-y-6">
            <p className="text-base md:text-lg text-gray-700 leading-relaxed">
              I'm <span className="font-semibold text-blue-600">Mohd Shamir</span>, a Computer Engineering student from KJ College, Pune.
