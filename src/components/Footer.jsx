...
const Footer = () => {
  const socialLinks = [
    ...
    { icon: Mail, link: 'mailto:mohdshamir7866@gmail.com', label: 'Email' }
  ];

  return (
    <footer className="bg-[#0f0f11] text-gray-200 py-10 border-t border-gray-700" >
      <div className="max-w-6xl mx-auto px-4 text-center">
        <h2 className="text-xl font-bold tracking-wide mb-3">Mohd Shamir</h2>
        <p className="text-sm text-gray-400 mb-6">
          © {new Date().getFullYear()} Mohd Shamir. All rights reserved.
        </p>
