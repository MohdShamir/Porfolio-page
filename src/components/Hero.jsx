...
const Hero = () => {
  return (
    <section id="home" className="w-full min-h-screen flex flex-col justify-center items-center px-6 md:px-20 bg-neutral-950 text-white">
      ...
      >
        Hi, I’m{" "}
        <span className="text-yellow-500">Mohd Shamir</span>
        <br />
        <span className="text-xl md:text-2xl font-semibold text-white-400">
          <Typewriter
      ...
      <motion.p
        ...
        className="mt-6 text-white-400 max-w-xl text-center text-lg"
      >
